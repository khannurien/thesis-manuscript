...
\boitemagique{Question 3 (\textbf{QR3})}{
    Du point de vue d'un fournisseur de services pour le cloud privé, comment évaluer l'impact de différentes politiques d'allocation de ressources et d'ordonnancement de tâches pour le modèle serverless ?
}
