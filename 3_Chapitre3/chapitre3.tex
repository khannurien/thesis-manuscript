...
TODO: Dans ce troisième chapitre, nous commençons par décrire les offres serverless commerciales, et les plateformes open source...
...
\textbf{Approche d'optimisation des environnements d'exécution}
...
\textbf{Approche par la mise en cache}
...
\subsection{État durable et état dynamique}
\label{sota-state}
...
\subsection{Isolation et sécurité}
\label{sota-isolation}
